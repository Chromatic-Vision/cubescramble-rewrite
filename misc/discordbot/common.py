...
async def create_embed(embed_data):
    ...
    if "color" not in embed_data or embed_data["color"] == "":
        embed_data["color"] = discord.Colour.from_rgb(random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
    ...
    for key in embed_data:
        if key == "fields":
            ...
            if embed_data[key]:
                ...
                try:
                    embed.set_author(name=embed_data[key]["name"], url=embed_data[key]["url"],
                                     icon_url=embed_data[key]["icon_url"])
                except:
                    pass
            ...
            if embed_data[key]:
                ...
                try:
                    ...
                    if "timestamp" not in embed_data:
                        embed.set_footer(text=f"Executed by {embed_data[key]['text']},{datetime.datetime.utcnow()}",
                                         icon_url=embed_data[key]["icon_url"])
